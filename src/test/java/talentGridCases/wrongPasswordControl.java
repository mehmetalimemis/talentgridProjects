...
public class wrongPasswordControl {
	public static void main(String[] args) throws InterruptedException {
		...
		oldPassword.sendKeys("Password01010101");
		...
		// Changes control
		WebElement updateTitle = driver.findElement(By.id("flash_error"));
		updateTitle.getText().contains("Wrong password");
